...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Opinion.object_id'
        db.alter_column('polls_and_opinions_opinion', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

        # Changing field 'Opinion.content_type'
        db.alter_column('polls_and_opinions_opinion', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenttypes.ContentType'], null=True))

    def backwards(self, orm):

        # Changing field 'Opinion.object_id'
        db.alter_column('polls_and_opinions_opinion', 'object_id', self.gf('django.db.models.fields.PositiveIntegerField')(default=0))

        # Changing field 'Opinion.content_type'
        db.alter_column('polls_and_opinions_opinion', 'content_type_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['contenttypes.ContentType']))
