...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Poll'
        db.create_table('polls_and_opinions_poll', (
        ...
        db.send_create_signal('polls_and_opinions', ['Poll'])

        # Adding model 'Choice'
        db.create_table('polls_and_opinions_choice', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('last_modified_on', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('poll', self.gf('django.db.models.fields.related.ForeignKey')(related_name='choices', to=orm['polls_and_opinions.Poll'])),
            ('is_approved', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('polls_and_opinions', ['Choice'])

        # Adding model 'Vote'
        db.create_table('polls_and_opinions_vote', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('voter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('choice', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'votes', to=orm['polls_and_opinions.Choice'])),
        ))
        db.send_create_signal('polls_and_opinions', ['Vote'])

        # Adding model 'Opinion'
        db.create_table('polls_and_opinions_opinion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_on', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('text', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('polls_and_opinions', ['Opinion'])


    def backwards(self, orm):
        # Deleting model 'Poll'
        db.delete_table('polls_and_opinions_poll')

        # Deleting model 'Choice'
        db.delete_table('polls_and_opinions_choice')

        # Deleting model 'Vote'
        db.delete_table('polls_and_opinions_vote')

        # Deleting model 'Opinion'
        db.delete_table('polls_and_opinions_opinion')
    ...
    models = {
        ...
        'polls_and_opinions.vote': {
            ...
            'choice': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'votes'", 'to': "orm['polls_and_opinions.Choice']"}),
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
