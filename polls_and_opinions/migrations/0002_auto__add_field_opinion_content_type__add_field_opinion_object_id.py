...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opinion.content_type'
        db.add_column('polls_and_opinions_opinion', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Opinion.object_id'
        db.add_column('polls_and_opinions_opinion', 'object_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opinion.content_type'
        db.delete_column('polls_and_opinions_opinion', 'content_type_id')

        # Deleting field 'Opinion.object_id'
        db.delete_column('polls_and_opinions_opinion', 'object_id')
