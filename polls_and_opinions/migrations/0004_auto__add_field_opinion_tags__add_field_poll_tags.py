...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Opinion.tags'
        db.add_column('polls_and_opinions_opinion', 'tags',
                      self.gf('tagging.fields.TagField')(default=''),
                      keep_default=False)

        # Adding field 'Poll.tags'
        db.add_column('polls_and_opinions_poll', 'tags',
                      self.gf('tagging.fields.TagField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Opinion.tags'
        db.delete_column('polls_and_opinions_opinion', 'tags')

        # Deleting field 'Poll.tags'
        db.delete_column('polls_and_opinions_poll', 'tags')
